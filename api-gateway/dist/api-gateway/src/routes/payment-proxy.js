...
router.use("/payments", auth_1.requireAuth, (0, requireFeature_1.requireFeature)(featureFlagTypes_1.Feature.PAYMENTS), // Gates entire payments API to allowed users
...
router.use("/razorpay/webhook", (0, http_proxy_middleware_1.createProxyMiddleware)({
    target: process.env.PAYMENT_SERVICE_URL || "http://localhost:4004",
    changeOrigin: true,
