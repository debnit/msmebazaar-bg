      ...
      <main className="flex-1">
        ...
        <section id="features" className="w-full py-12 md:py-24 lg:py-32 bg-gray-50">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Complete MSME Solutions</h2>
                <p className="max-w-[900px] text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl items-start gap-6 py-12 lg:grid-cols-3 lg:gap-8">
              <Card>
                ...
                <CardContent>
                  <blockquote className="text-sm">
                    "MSMEBazaar helped us secure a ₹25 lakh loan in just 2 weeks. The process was smooth and
                    transparent. Highly recommended for any MSME looking for quick funding."
                  </blockquote>
                  <div className="mt-4">
              ...
              <Card>
                ...
                <CardContent>
                  <blockquote className="text-sm">
                    "The business valuation service was exceptional. We got a detailed report that helped us attract
                    investors and raise ₹1 crore in Series A funding."
                  </blockquote>
                  <div className="mt-4">
              ...
              <Card>
                ...
                <CardContent>
                  <blockquote className="text-sm">
                    "Through their market linkage program, we connected with 5 new distributors and increased our
                    sales by 40% in 6 months. Amazing platform!"
                  </blockquote>
                  <div className="mt-4">
        ...
        <section id="pricing" className="w-full py-12 md:py-24 lg:py-32 bg-gray-50">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Start Your Growth Journey</h2>
                <p className="max-w-[900px] text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-blue-600">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-white">Ready to Grow Your Business?</h2>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-white">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Have Questions? Let's Talk!</h2>
                <p className="max-w-[900px] text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Our MSME experts are here to help you grow your business. Send us your enquiry and we'll get back to
                  you within 24 hours.
                </p>
              </div>
            </div>
            ...
            <div className="max-w-2xl mx-auto">
              <Card className="shadow-lg border-0">
                <CardHeader>
                  ...
                  <CardDescription className="text-center">Fill out the form below and our team will contact you soon</CardDescription>
                </CardHeader>
                <CardContent>
                  <EnquiryForm />
                </CardContent>
      ...
      <footer id="contact" className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t bg-gray-50">
        <div className="container mx-auto">
          ...
          <div className="flex flex-col gap-2 sm:flex-row py-6 w-full items-center border-t mt-8">
            <p className="text-xs text-gray-600">© {new Date().getFullYear()} MSMEBazaar. All rights reserved.</p>
            <nav className="sm:ml-auto flex gap-4 sm:gap-6">
              ...
              <Link
                className="text-xs hover:underline underline-offset-4 text-blue-600 font-medium"
                href="mailto:support@msmebazaar.com"
              >
                Support
              </Link>
            </nav>
